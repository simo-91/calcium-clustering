...
```{r tag redcells using redcell.npy}
...
saveRDS(spks, file = "ID0040_spks.rds")
write.csv(spks, "ID0040_spks.csv")
```
...
saveRDS(spksthresholded, file = "ID0040_spksthresholded.rds")
write.csv(spksthresholded, "ID0040_spksthresholded.csv")
```
...
saveRDS(spksSUM, file = "ID0040_spksSUM.rds")
write.csv(spksSUM, file = "ID0040_spksSUM.csv")
...
saveRDS(spksSUM2, file = "ID0040_spksSUM2.rds")
write.csv(spksSUM2, file = "ID0040_spksSUM2.csv")
...
saveRDS(RFPsum, file = "ID0040_RFPsum.rds")
write.csv(RFPsum, file = "ID0040_RFPsum.csv")
...
saveRDS(RFPsum2, file = "ID0040_RFPsum2.rds")
write.csv(RFPsum2, file = "ID0040_RFPsum2.csv")
...
ID0040.posXY.RFP <- ID0040.posXY[which(ID0040.posXY$RFP=="TRUE"),]

saveRDS(ID0040.posXY.RFP, file = "ID0040.posXY.RFP.rds")
write.csv(ID0040.posXY.RFP, file = "ID0040.posXY.RFP.csv")
ID0040.posXY.RFP
```
