...
ID0031.posXY <- subset(ID0031.posXY, Positive == 1, select = c(Y,X,Cell))
...
saveRDS(spks, file = "ID0031_spks.rds")
write.csv(spks, "ID0031_spks.csv")
...
saveRDS(spksthresholded, file = "ID0031_spksthresholded.rds")
write.csv(spksthresholded, "ID0031_spksthresholded.csv")
...
saveRDS(spksSUM, file = "ID0031_spksSUM.rds")
write.csv(spksSUM, file = "ID0031_spksSUM.csv")
...
saveRDS(spksSUM2, file = "ID0031_spksSUM2.rds")
write.csv(spksSUM2, file = "ID0031_spksSUM2.csv")
...
ID0031.raster.hc <- ggplot(meltPeaks, aes(time, cell))+
...
saveRDS(RFPsum, file = "ID0031_RFPsum.rds")
write.csv(RFPsum, file = "ID0031_RFPsum.csv")
...
saveRDS(RFPsum2, file = "ID0031_RFPsum2.rds")
write.csv(RFPsum2, file = "ID0031_RFPsum2.csv")
...
ID0031.RFP.raster <- ggplot(meltPeaks.RFP, aes(time, cell))+
  geom_raster(aes(fill = `Ca2+`))+
...
ID0031.posXY.RFP <- ID0031.posXY[which(ID0031.posXY$RFP=="TRUE"),]

saveRDS(ID0031.posXY.RFP, file = "ID0031.posXY.RFP.rds")
write.csv(ID0031.posXY.RFP, file = "ID0031.posXY.RFP.csv")
