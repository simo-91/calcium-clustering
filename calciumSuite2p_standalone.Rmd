...
posXY$frequency <- rowSums(spksthresholded)/60
...
ggsave(plot = arranged, file = "/Users/Simo/calcium-clustering/plots/ID0031.whole.RFP.png", 
       device = "png",  bg = "white",
...
# Save graph
ggsave(plot = graph.plt, file = "/Users/Simo/calcium-clustering/plots/ID0031.graph.png", 
       device = "png",  bg = "white",
       width = 20, height = 15, units = "cm", dpi = 320,
       scale = 2)
...
# Save graph
ggsave(plot = graph.btw.plt, file = "/Users/Simo/calcium-clustering/plots/ID0031.graph.btw.plt.png", 
       device = "png",  bg = "white",
       width = 20, height = 15, units = "cm", dpi = 320,
       scale = 2)
