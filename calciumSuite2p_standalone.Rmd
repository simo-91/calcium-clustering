...
saveRDS(spks, file = "~/calcium-clustering/data/ID0096_spks.rds")
write.csv(spks, "~/calcium-clustering/data/ID0096_spks.csv")
...
saveRDS(spksthresholded, file = "~/calcium-clustering/data/ID0096_spksthresholded.rds")
write.csv(spksthresholded, "~/calcium-clustering/data/ID0096_spksthresholded.csv")
...
saveRDS(spksSUM, file = "~/calcium-clustering/data/ID0096_spksSUM.rds")
write.csv(spksSUM, file = "~/calcium-clustering/data/ID0096_spksSUM.csv")
...
saveRDS(frequency, file = "~/calcium-clustering/data/ID0096_mean_frequency.rds")
write.csv(frequency, file = "~/calcium-clustering/data/ID0096_mean_frequency.csv")
...
saveRDS(spksSUM2, file = "~/calcium-clustering/data/ID0096_spksSUM2.rds")
write.csv(spksSUM2, file = "~/calcium-clustering/data/ID0096_spksSUM2.csv")
...
raster.hc <- ggplot(meltPeaks, aes(time, cell))+
  ...
  ggtitle("ID0096 hclust", subtitle = sprintf("Mean frequency is: %s events/min", round(frequency, digits = 3)))
...
# Save data
ggsave(plot = grid, file = "/Users/Simo/calcium-clustering/plots/ID0096.grid-allcells.png", 
       device = "png",  bg = "white",
       width = 20, height = 15, units = "cm", dpi = 320,
       scale = 2)
saveRDS(posXY, file = "~/calcium-clustering/data/ID0096_posXY.rds")
write.csv(posXY, file = "~/calcium-clustering/data/ID0096_posXY.csv")
...
saveRDS(RFPsum, file = "~/calcium-clustering/data/ID0096_RFPsum.rds")
write.csv(RFPsum, file = "~/calcium-clustering/data/ID0096_RFPsum.csv")
...
saveRDS(RFPsum2, file = "~/calcium-clustering/data/ID0096_RFPsum2.rds")
write.csv(RFPsum2, file = "~/calcium-clustering/data/ID0096_RFPsum2.csv")
...
RFP.raster <- ggplot(meltPeaks.RFP, aes(time, cell))+
  ...
  theme(legend.position = "none",
        ...
        plot.title = element_text(colour = "red", hjust = .5))+
  ggtitle("ID0096 RFP+", subtitle = sprintf("Mean frequency is: %s events/min", round(frequency.RFP, digits = 3)))
...
ggsave(plot = arranged, file = "/Users/Simo/calcium-clustering/plots/ID0096.whole.RFP.png", 
       device = "png",  bg = "white",
       width = 20, height = 15, units = "cm", dpi = 320,
       scale = 2)
...
# posXY.RFP$Member <- duplicated(posXY.RFP$Community) to be fixed
# posXY.RFP$degree <- ordered(degree(graph.RFP))
...
# Save graph
ggsave(plot = graph.plt, file = "/Users/Simo/calcium-clustering/plots/ID0096.graph.png", 
       device = "png",  bg = "white",
       width = 20, height = 15, units = "cm", dpi = 320,
       scale = 2)
...
graph.btw.plt <- ggraph(graph, 
                                         ...
                                         scale_size_manual(values = c("0" = 5,
                                          ...
                                          ggtitle("ID0096 RFP+ highlighted")+
                                          scale_y_reverse() #this is because in images/movies y axis in coordinates is reversed

# Save graph
ggsave(plot = graph.btw.plt, file = "/Users/Simo/calcium-clustering/plots/ID0096.graph.btw.plt.png", 
       device = "png",  bg = "white",
       width = 20, height = 15, units = "cm", dpi = 320,
       scale = 2)
