...
#### In the general population (ALL GCaMP6s+ cells, redcells included)
...
```
#### IRF8-/- mutants
```{r all genos clustcoeff with IRF8nulls, message=FALSE, warning=FALSE, fig.cap=""}
